...
\[H^{\mu\alpha\nu\beta}_{\phantom{****},\alpha\beta} = 16\pi T^{\mu\nu},\]
where
...
\[\tensor{\overline{h}}{^{\mu\alpha}_{,\alpha}} = 0,\] 
...
\[\Box \xi \equiv \tensor{\xi}{^{\alpha,\beta}_{\beta}} = 0.\]
...
\begin{eqnarray}
ds^2 &=& -\left[1-\frac{2M}{r} + O\left(\frac{1}{r^3}\right) \right]dt^2 - \left[4\epsilon_{jkl}S^k \frac{x^l}{r^3} + O\left(\frac{1}{r^3}\right)  \right] dtdx^j  \nonumber \\
&+& \left[\left(1+\frac{2M}{r}\right)\delta_{jk} + \mbox{ gravitational radiation terms that die out as } O(1/r) \right]dx^j dx^k , \nonumber
\end{eqnarray}
where
\[M \equiv \int T^{00}d^3x , \quad S_k \equiv \int \epsilon_{klm}x^l T^{m0} d^3x .\]
It is plausible to say the mass of the system is $M$ and the angular momentum $\bm{S}$. With an appropriate choice of gauge, $g_{00}$ far from any weak source are time-independent and determined uniquely by the source's mass $M$; $g_{0j}$ is time-independent and is fixed by the source's intrinsic angular momentum $S^j$; but $g_{jk}$ has time-dependent terms (gravitational waves) of $O(1/r)$.
\\ \\
...
We have
\begin{eqnarray}
ds^2 &=& -\left[1-\frac{2M}{r} + \frac{2M^2}{r^2} + O\left(\frac{1}{r^3}\right) \right]dt^2 - \left[4\epsilon_{jkl}S^k \frac{x^l}{r^3} + O\left(\frac{1}{r^3}\right)  \right] dtdx^j  \nonumber \\
&+& \left[\left(1+\frac{2M}{r} + \frac{3M^2}{2r^2}\right)\delta_{jk} + \mbox{ gravitational radiation terms that die out as } O({1}/{r}) \right]dx^j dx^k. \nonumber
\end{eqnarray}
...
\begin{figure}[!htb]
\centering
\includegraphics[scale=0.25]{GR/BH2.eps}
...
\begin{eqnarray}
    T &=& \left( \frac{r}{2M} -1 \right)^{1/2} e^{r/4M}\sinh \left( \frac{t}{4M}\right), \quad R = \pm\left( \frac{r}{2M} -1 \right)^{1/2} e^{r/4M}\cosh\left( \frac{t}{4M}\right), \quad r > 2M \nonumber \\
    T &=& \pm \left(1 - \frac{r}{2M}\right)^{1/2} e^{r/4M}\cosh \left( \frac{t}{4M}\right), \quad R = \left(1 - \frac{r}{2M} \right)^{1/2} e^{r/4M}\sinh\left( \frac{t}{4M}\right), \quad r < 2M. \nonumber
\end{eqnarray}
The metric becomes
\[ds^2 = \frac{32M^3}{r}e^{-r/2M}(-dT^2+dR^2) + r^2 d\Omega^2.\]
We can now draw a spacetime diagram in the $T-R$ plane, known as a Kruskal diagram, representing the maximal extension of the Schwarzschild geometry.
...
\begin{figure}[!htb]
\centering
\includegraphics[scale=0.12]{GR/BH4.png}
...
\[\delta M = \frac{\kappa}{8\pi G} \delta A + \Omega_{\rm H}\delta J,\]
where
...
\[ m^2\left(\frac{dr}{d\tau} \right)^2 = \frac{[(r^2+a^2)E-aL]^2}{r^4} - \frac{\Delta[(aE-L)^2+ m^2r^2]}{r^4}.\]
